...
public class SortingUtility {
    ...
    private static  <T extends Comparable<T>> int partition(T[] data, int min, int max) {
        ...
        //use middle data value as partition
        ...
        while(left < right) {
            ...
            //search for element that is > partition elm
            while(left < right && data[left].compareTo(partitionElement) <= 0) {
                left++;
            }

            //search for an element that is < partition elm
    ...
    private static <T extends Comparable<T>> void merge(T[] data, int first, int mid, int last) {
        ...
        /*
        copy smaller items from each subarray into temp until one is exhausted
         */
        ...
        //copy merged data into original
